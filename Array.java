...
/**
 * This Java program takes user input to create an array of numbers, and then finds and prints the
 * largest number in the array.
 */
/**
 * The above class prompts the user to enter the size of an array and then allows the user to input
 * numbers at each index of the array.
 */
